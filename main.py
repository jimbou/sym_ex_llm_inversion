...
def main():
    ...
    #get io_vars
    inputs, outputs = get_io_vars(model_io, difficult_func, full_code, log_folder, solutions_pre[0], solutions_post[0])

    #find the subset of the constraints pre only for the inputs
    # Extract the subset of the solution for input variables
    solutions_pre_0 = solutions_pre[0]
    ...
    solutions_post_0 = solutions_post[0]
    ...
    inital_seed = get_inital_seed(model_seed, difficult_func, inputs, outputs, pre_constraints, post_constraints, inputs_subset, outputs_subset)
    ...
    get_modified_script(model_modified, difficult_func, full_code, modified_script_path, solutions_pre[0], inputs)
    ...
    for solution in solutions_post:
        ...
        inputs_concrete= inverted_solutions_simple(model_inverted, difficult_func, solution_str)
